  ...
  d3.layout.nmap = function(){
    ...
    function split(nodes, x1, y1, x2, y2, direction){
      ...
      if(direction == HORIZONTAL) {
        ...
        split(nodesLeft, x1, y1, x2, y1 + (y2 - y1) * ratioLeft, HORIZONTAL);
        split(nodesRight, x1, y1 + (y2 - y1) * ratioLeft, x2, y2, HORIZONTAL);
      }*/
    ...
    function nmap(nodes){
      ...
      var xExtent = d3.extent(nodes, function(node){return node._ix;}),
          yExtent = d3.extent(nodes, function(node){return node._iy;})
      ;
